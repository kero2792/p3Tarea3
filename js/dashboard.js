    ...
    librosCache.forEach(libro => {
        ...
        tr.innerHTML = `
            ...
            <td class="action-buttons">
                ...
                <button class="btn btn-danger btn-sm" onclick="eliminarLibro(${libro.id})" title="Eliminar">
...
async function eliminarLibro(id) {
    if (!confirm('¿Estás seguro de que deseas eliminar este libro? Esta acción cambiará su estado a "No disponible".')) {
        return;
    }
    ...
    try {
        ...
        if (result.success) {
            ...
            mostrarMensaje(result.message || 'Error al eliminar el libro', 'danger');
        }
    } catch (error) {
        mostrarMensaje('Error de conexión al eliminar el libro', 'danger');
    }
}
